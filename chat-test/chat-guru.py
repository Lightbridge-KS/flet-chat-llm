import flet as ft
from assistant01 import AssistantV01
...
def main(page: ft.Page):
    ...
    # creating the object of AssistantV01 class
    assistantV01 = AssistantV01()
    ...
    def send_message_click(e):
        if new_message.value != "":
            ...
            # fetching the SmartGuru AI response get_response
            ai_response = assistantV01.get_response(str(new_message.value))
    ...
    page.add(
        ft.Row([ft.Text("SMARTGURU AI", style="headlineLarge", color="blue")], alignment="center"),
        ft.Container(
            content=chat,
